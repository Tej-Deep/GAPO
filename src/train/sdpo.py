...
if __name__ == "__main__":
    parser = H4ArgumentParser((DataArguments, ModelConfig, SDPOConfig))
    ...
    ref_model = architecture.from_pretrained(model_args.model_name_or_path, **model_kwargs)


    # NOTE: Changes made to accomodate for phi4 (initialising model here instead of trainer)
    ...
    ################
    # NOTE: Changes made to accomodate phi4 
    # (since model is intialised set kwargs to None)
